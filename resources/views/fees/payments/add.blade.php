                ...
                <div class="card-body">
                    ...
                    <form method="post"  action="{{ route('payment.store') }}" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{trans('students.credit')}} : </label>
                                    <input  class="form-control" name="credit" value="{{ number_format($student->student_account->sum('debit') - $student->student_account->sum('credit'), 2) }}" type="text" readonly>
                                </div>
                            </div>
                        </div>

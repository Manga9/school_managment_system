...
@section('page-header')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0">{{trans('teachers.edit')}} ({{$teacher->name}})</h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right">
                    <li class="breadcrumb-item"><a href="{{route('dashboard')}}" class="default-color">{{trans('main.home')}}</a></li>
                    <li class="breadcrumb-item active">{{trans('teachers.edit')}}</li>
                </ol>
                <br>
            </div>
        </div>
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <form method="Post" action="{{route('teachers.update', $teacher->id)}}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input required type="email" class="form-control" id="email" name="email" value="{{ $teacher->email }}">
                                    @error('email')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input required type="password" class="form-control" id="password" name="password" value="{{ $teacher->password }}">
                                    @error('password')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input required type="text" class="form-control" id="name_en" name="name_en" value="{{ $teacher->getTranslation('name', 'en') }}">
                                    @error('name_en')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input required type="text" class="form-control" id="name_ar" name="name_ar" value="{{ $teacher->getTranslation('name', 'ar') }}">
                                    @error('name_ar')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="box">
                                        <select required class="fancyselect" name="spec">
                                            ...
                                            @foreach($specs as $spec)
                                                <option
                                                    @if($teacher->specialization_id == $spec->id) selected @endif
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input required type="date" class="form-control" id="joining_date" name="join" value="{{ $teacher->joining_date }}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <br>
                                <div class="mb-3">
                                    ...
                                    <textarea required class="form-control" id="address" name="address">{{ $teacher->address }}</textarea>
                                    @error('address')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <br>
                        @enderror
                        <button type="submit" class="btn btn-primary">{{trans('teachers.edit')}}</button>
                    </form>
                </div>
            </div>
        </div>
